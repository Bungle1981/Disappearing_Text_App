...
window = Tk()
window.update()
window.title("The amazing disappearing text app")
...
subtitlelabel = Label(text="As soon as you stop typing in the box below, the countdown will start. If you don't start typing again within 10 seconds, you will lose your work.")
